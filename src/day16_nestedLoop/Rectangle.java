...
public class Rectangle {
    public static void main(String[] args) {
        ...
        while (true){
            ...
            if(answer.equals("no")) {System.out.println("Thank you for using Cydeo Rectangle Calculator APP");break;}
        }
    }
}
/*
Write a program that can calculate the area and perimeter of a Rectangle:
                        1. Ask the user "Enter the length of the Rectangle:"
                                ...
                                message "Invalid Entry for the length of the rectangle"
                        2. Ask the user "Enter the width of the Rectangle:"
                                if user enters 0 or negative numbers, terminate the program after displaying the error
                                message "Invalid Entry for the width of the rectangle"
                        3. Display:
                                        1. Area of rectangle
                        ...
                        4. Ask the user "Would you like to calculate another Rectangle?"
                                ...
                                If user enters an invalid entry, ask the user to re-enter until user provides a valid
                                entry
